...
class Attempt {
    ...
    createSummary() {
        ...
        let clipboardText = `${this.solved}/${this.attempted} MBLD attempt in ${formatTime(this.splits[this.splits.length-1].globalTime)+"+".repeat(this.plusTwos)}[${formatTime(this.splits[this.splits.length-2].globalTime)}]\nended at ${slicedTime}\n`;
